...
if __name__ == "__main__":
    ...
    if norm == 'nonorm':
        ...
        patch_dir = preproc_conf["patch_dir_macenko_bracs"]
        dest_dir = preproc_conf["uni_finetuned_emb_dir_macenko"]
    else:
    ...
    loaded = torch.load(preproc_conf.uni_embedder_finetuned_weights_macenko, map_location="cpu")
    ...
    transform = transforms.Compose(
        [
            #transforms.Resize(224), # already at this size !
            transforms.ToTensor(),
...
# nohup 
# python generate_finetuned_uni_embeddings.py --config_level_0  classic_mil_on_embeddings_bag --config_level_1 tcga_brca_224_224_patches_jmcs --maxnum_threads 1 --num 0 --norm macenko
